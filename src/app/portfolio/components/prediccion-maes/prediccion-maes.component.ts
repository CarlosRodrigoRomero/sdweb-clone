...
export class PrediccionMaesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const dataVarMae = [
      ...
      [0.62, 1.01, 1.54, 2.56, 3.85, 5.52, 7.4, 10.07 /* , 13.92, 19.62, 28.18 */], // Planta 3 -
      ...
      [1.22, 1.28, 1.41, 1.62, 1.83, 2.33, 2.91, 3.62 /* , 4.52, 5.69, 7.3 */], // Planta 8
      ...
      [1.01, 1.38, 1.85, 2.48, 3.33, 4.54, 6.31, 8.95 /* , 12.94, 19.07, 28.54 */], // Planta 11 -
  ...
  initChart() {
    this.chartOptions = {
      ...
      colors: [GLOBAL.colores_new_mae[2], GLOBAL.colores_new_mae[0], GLOBAL.colores_new_mae[1]],
    };
