...
export class DownloadPdfComponent implements OnInit {
                  ...
                  [
                    {
                      text: this.datePipe
                        .transform(this.informe.fecha * 1000, 'dd/MM/yyyy')
                        .concat(' ')
                        .concat(this.datePipe.transform(s.anomaliasCliente[0].datetime * 1000, 'HH:mm:ss')),
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    },

                    {
                      text: Math.round(s.anomaliasCliente[0].irradiancia).toString().concat(' W/m2'),
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    },
                    {
                      text: Math.round((s.anomaliasCliente[0] as PcInterface).temperaturaAire)
                        .toString()
                        .concat(' ºC'),
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    ...
                    {
                      text: (s.anomaliasCliente[0] as PcInterface).viento,
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    },

                    {
                      text: (s.anomaliasCliente[0] as PcInterface).emisividad,
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    },

                    {
                      text: Math.round((s.anomaliasCliente[0] as PcInterface).temperaturaReflejada)
                        .toString()
                        .concat(' ºC'),
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    ...
                    {
                      text: this.writeModulo(s.anomaliasCliente[0]),
                      style: 'tableCellAnexo1',
                      noWrap: true,
                    },
                  ],
  ...
  private getEncabezadoTablaSeguidor(columna) {
