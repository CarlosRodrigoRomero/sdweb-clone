...
@Component({
  ...
  templateUrl: './old-pc-details-dialog.component.html',
  styleUrls: ['./old-pc-details-dialog.component.css'],
})
export class OldPcDetailsDialogComponent implements OnInit {
