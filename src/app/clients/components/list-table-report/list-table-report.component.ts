...
@Component({
  selector: 'app-list-table-report',
  templateUrl: './list-table-report.component.html',
  styleUrls: ['./list-table-report.component.css'],
})
export class ListTableReportComponent implements OnInit {
