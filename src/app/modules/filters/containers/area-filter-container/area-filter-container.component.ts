...
@Component({
  selector: 'app-area-filter-container',
  templateUrl: './area-filter-container.component.html',
  styleUrls: ['./area-filter-container.component.css'],
})
export class AreaFilterContainerComponent implements OnInit {
  map: Map;
  activeDraw = false;
  activeDelete = false;
  private draw: Draw;
