...
//       [
//         transform(
//           [-5.950534343719482, 39.45960594494292],
//           "EPSG:4326",
//           "EPSG:3857"
//         ),
//         transform(
//           [-5.949568748474121, 39.459655645582245],
//           "EPSG:4326",
//           "EPSG:3857"
//         ),
//         transform(
//           [-5.949075222015382, 39.45892669931527],
//           "EPSG:4326",
//           "EPSG:3857"
//         ),
//         transform(
//           [-5.950169563293458, 39.45892669931527],
//           "EPSG:4326",
//           "EPSG:3857"
//         )
//       ]
...
//     this.map = new OlMap({
//       target: "mapid",
//       layers: [this.vectorLayer, tileLayer],
//       loadTilesWhileInteracting: true,
//       view: new OlView({
//         center: fromLonLat([-5.950558, 39.460472]),
//         zoom: 16
//       })
//     });
//   }
...
//     const text =
//       feature.getProperties().name + " " + area.toFixed(0) + " km<sup>2</sup>";
...
//   // display the country name and area now
//   const text =
//     feature.getProperties().name + " " + area.toFixed(1) + " km<sup>2</sup>";
//   document.getElementById("closestFeature").innerHTML = text;
// });
